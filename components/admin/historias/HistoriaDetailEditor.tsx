...
const contextoFields: FieldDef[] = [
  ...
  {
    name: "desafios",
    label: "Desafíos (JSON — array de strings)",
    kind: "json",
    rows: 6,
    gridSpan: 2,
    hint: 'Ejemplo: ["Estructura en zona sísmica", "Peso de 200 ton"]',
  },
]
...
const solucionFields: FieldDef[] = [
  ...
  {
    name: "innovaciones",
    label: "Innovaciones (JSON — array)",
    kind: "json",
    rows: 6,
    gridSpan: 2,
    hint: 'Ejemplo: ["Soldadura robotizada", "Modelo BIM 4D"]',
  },
]
...
const multimediaFields: FieldDef[] = [
  ...
  { name: "videoUrl", label: "Video URL", kind: "video", gridSpan: 2 },
  {
    ...
    label: "Imágenes del desafío (JSON array)",
    kind: "json",
    rows: 6,
    gridSpan: 2,
    hint: 'Ej: ["https://...jpg", "https://...jpg"]',
  },
  {
    name: "imagenesSolucion",
    label: "Imágenes de la solución (JSON array)",
    kind: "json",
    rows: 6,
    gridSpan: 2,
  },
  {
    ...
    label: "Imágenes del resultado (JSON array)",
    kind: "json",
    rows: 6,
    gridSpan: 2,
  },
...
const metricasFields: FieldDef[] = [
  ...
  {
    name: "tagsTecnicos",
    label: "Tags técnicos (JSON array)",
    kind: "json",
    rows: 4,
    gridSpan: 2,
  },
