      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-blue-400 font-bebas uppercase text-xl mb-2">Sobre MEISA</h2>
            <h3 className="text-5xl md:text-6xl font-bebas uppercase text-white mb-6">
            ...
            <p className="text-gray-300 font-lato text-lg mb-6 leading-relaxed">
              Fundada en <strong className="text-red-500 font-lato">1996 en Popayán, Cauca</strong>, MEISA (Metálicas e Ingeniería S.A.S.)
            ...
            <p className="text-gray-300 font-lato text-lg mb-6 leading-relaxed">
              ...
              contribuido al desarrollo del país: desde el <strong className="text-blue-400 font-lato">Puente La Floresta en Bogotá</strong> hasta el
              <strong className="text-blue-400 font-lato"> Centro Comercial Campanario en Popayán</strong>, pasando por terminales de transporte masivo,
              plantas industriales y escenarios deportivos.
            </p>

            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 mb-8 border border-gray-700">
              <h4 className="text-white font-bebas uppercase text-2xl mb-4">Nuestra Misión</h4>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 mb-8 border border-gray-700">
              <h4 className="text-white font-bebas uppercase text-2xl mb-4">Nuestra Visión</h4>
              <p className="text-gray-300 font-lato leading-relaxed">
            ...
            <div className="mb-8">
              <h4 className="text-white font-bebas uppercase text-2xl mb-4">Nuestra Historia</h4>
                    ...
                    >
                      <div className="flex items-center gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          <span className="text-red-500 font-bebas uppercase text-lg font-semibold block">{milestone.year}</span>
                          <span className="text-gray-300 font-lato text-sm">{milestone.event}</span>
                        </div>
                      </div>
                    </motion.div>
                  )
            ...
            >
              <Link
                href="/nosotros"
                className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-lato font-bold rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105"
              >
              ...
              <Link
                href="/politicas"
                className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 text-white font-lato font-bold rounded-lg hover:bg-white/20 transition-all duration-300"
              >
                ...
                return (
                  ...
                  >
                    <div className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-gray-600 transition-all duration-300">
                      ...
                      <h5 className="text-white font-bebas uppercase text-lg mb-2">{feature.name}</h5>
                      <p className="text-gray-400 font-lato text-sm">{feature.description}</p>
                    </div>
                  </motion.div>
                )
              })}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <div className="flex justify-around">
                    <div className="text-center">
                      <p className="text-4xl font-bebas text-white">1996</p>
                      <p className="text-sm font-lato text-gray-300">Fundación</p>
                    </div>
                    <div className="text-center">
                      <p className="text-4xl font-bebas text-white">3</p>
                      <p className="text-sm font-lato text-gray-300">Generaciones</p>
                    </div>
                    <div className="text-center">
                      <p className="text-4xl font-bebas text-white">{siteConfig.empresa.aniosExperiencia}+</p>
                      <p className="text-sm font-lato text-gray-300">Años líder</p>
                    </div>
                  </div>
                </div>
              </div>
