...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div className={cn(
        "hidden lg:block bg-gradient-to-r from-gray-900 to-gray-800 text-white text-sm transition-all duration-300 fixed top-0 left-0 right-0 z-40",
      ...
      <nav className={cn(
        ...
        scrolled 
          ...
          : "top-10 bg-white/90 backdrop-blur-md shadow-md"
      )}>
              ...
              <div className="px-4 py-6 space-y-4">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-4 mb-4">
                  ...
                  <div className="flex items-center gap-2 text-blue-600 text-xs mt-1">
                    <span>600 ton/mes</span> • <span>27+ años</span> • <span>3 plantas</span>
                  </div>
                </div>
