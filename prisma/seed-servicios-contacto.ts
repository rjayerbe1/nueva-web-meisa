...
const FASES = [
  {
    ...
    fortalezas: [
      ...
      "Modelado 3D con Tekla Structures",
      "Análisis y diseño con ETABS, SAP2000 y Midas",
  ...
  },
  {
    ...
    descripcion:
      "Producción especializada con tecnología CNC y gestión integrada de la fabricación",
    fortalezas: [
      "Corte CNC con FastCAM de alta precisión",
      "Sistema propio de gestión de producción",
      "Soldadura calificada bajo código AWS D1.1",
      "Granallado y sistema de pintura anticorrosiva",
      "Estructuras fabricadas con trazabilidad completa",
      "Despacho coordinado con el plan de montaje",
    ],
    icono: "Cog",
  },
  {
    ...
    fortalezas: [
      ...
      "Inspección continua con Sistema Integrado de Gestión (SIG)",
      "Protocolos de seguridad bajo SG-SST",
  ...
  },
  {
    ...
    fortalezas: [
      ...
      "Garantía de calidad sobre la estructura entregada",
