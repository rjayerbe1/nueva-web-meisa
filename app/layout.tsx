...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'construcciones metálicas Colombia',
    'empresa metalmecánica Colombia',
    'cerchas metálicas',
    'mezzanines y entrepisos metálicos',
    'estructura metálica para paneles solares',
    'naves para datacenters',
  ],
