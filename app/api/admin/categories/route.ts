  ...
  try {
    ...
    const categoria = await prisma.categoriaProyecto.create({
      data: {
        ...
        usarVideoCover: data.usarVideoCover || false,
        videoCoverScale: data.videoCoverScale ?? 1.0,
        videoCoverPosition: data.videoCoverPosition || '0,0',
        imagenBanner: data.imagenBanner || null,
        videoBanner: data.videoBanner || null,
        usarVideoBanner: data.usarVideoBanner || false,
        videoBannerScale: data.videoBannerScale ?? 1.0,
        videoBannerPosition: data.videoBannerPosition || '0,0',
