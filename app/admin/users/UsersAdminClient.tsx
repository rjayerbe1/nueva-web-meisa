...
export default function UsersAdminClient({ initialUsers, currentUserId }: UsersAdminClientProps) {
  ...
  // Verificación de sesión admin ya ocurrió en el server component (page.tsx)
