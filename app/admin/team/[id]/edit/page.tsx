    ...
    const fetchTeamMember = async () => {
      try {
        ...
        if (response.ok) {
          ...
          alert('Error al cargar el miembro del equipo')
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Editar Miembro del Equipo</h1>
            <p className="text-gray-600">Modifica la información del miembro del equipo</p>
          </div>
        </div>
      </div>
