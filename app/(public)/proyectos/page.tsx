...
export const metadata: Metadata = {
  ...
  description:
    'Conozca nuestros proyectos de estructuras metálicas en Colombia: puentes vehiculares y peatonales, centros comerciales, edificios, naves industriales, estadios y más. Portafolio de MEISA con +40 años de experiencia.',
  keywords: [
