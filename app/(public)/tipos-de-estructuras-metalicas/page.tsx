...
const SLUG = 'tipos-de-estructuras-metalicas'
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Tipos de estructuras metálicas — guía completa MEISA',
        },
      ],
      type: 'website',
    },
...
export default async function TiposDeEstructurasMetalicasPage() {
  const guia = await getGuia()
