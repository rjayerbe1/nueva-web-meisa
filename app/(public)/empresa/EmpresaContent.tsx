        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
              {getText(`Con más de ${siteConfig.empresa.aniosExperiencia} años de experiencia, MEISA continúa siendo el aliado estratégico para proyectos de estructuras metálicas en Colombia.`, 'cta.subtitle')}
            </p>
