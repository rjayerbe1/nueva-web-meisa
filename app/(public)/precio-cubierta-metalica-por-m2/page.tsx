...
const SLUG = 'precio-cubierta-metalica-por-m2'
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'Precio de cubierta metálica por m² en Colombia — MEISA',
        },
      ],
      type: 'website',
    },
...
export default async function PrecioCubiertaMetalicaPorM2Page() {
  const guia = await getGuia()
